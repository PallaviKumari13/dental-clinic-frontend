...
const Services = () => {
  return (
    <section id="team" className="bg-green-200 bg-cover"  style={{ backgroundImage: 'url("../src/assets/border2.jpg")' }}>
      
        <div className="text-center py-40">
          <h3 className="text-4xl font-bold text-green-900 mb-30 animate__animated animate__fadeIn animate__delay-1s">Our Speciality</h3>
          <div className="flex flex-wrap justify-center ">
          <div className="container mx-auto py-8">
            
          <ServiceCard price="Starting From ₹1,500-30,000" title="Teeth Braces" link="Login.aspx" delay="0.4s" />
